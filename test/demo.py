...
print(Fore.RED + Back.YELLOW + "Hello world" + Fore.RESET + "End world")
print(Fore.RED + Back.YELLOW + "Hello world" + Back.RESET + "End world")
print(Fore.RED + Back.YELLOW + "Hello world" + Style.RESET_ALL + "End world")
...
for foreground in FORES:
    sys.stdout.write('%s%-6s' % (foreground, NAMES[foreground]))
print()
...
for background in BACKS:
    ...
    for foreground in FORES:
        ...
        sys.stdout.write('%s  X  ' % Style.NORMAL)
